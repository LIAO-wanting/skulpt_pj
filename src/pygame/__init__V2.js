...
var display_mod = function (name) {
    let mod= {__name__: new Sk.builtin.str("pygame.display")};
    // var mod = {};
...
var $builtinmodule = function (name) {
    var mod = {__name__: new Sk.builtin.str("pygame")};
